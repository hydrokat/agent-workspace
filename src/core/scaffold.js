...
export function ensureDirs(target) {
  const dirs = [
    ...
    'knowledgebase/api-design',
    'knowledgebase/architecture-decisions',
    'knowledgebase/coding-standards',
    'knowledgebase/db-schema',
    'specs',
    '.agent-workspace',
    '.tmp',
  ];
...
export function initStarterFiles(target, dryRun = false) {
  const starters = [
    ...
    ['knowledgebase/api-design/README.md', readTemplate('knowledgebase', 'api-design', 'README.md')],
    ['knowledgebase/architecture-decisions/README.md', readTemplate('knowledgebase', 'architecture-decisions', 'README.md')],
    ['knowledgebase/coding-standards/README.md', readTemplate('knowledgebase', 'coding-standards', 'README.md')],
    ['knowledgebase/db-schema/README.md', readTemplate('knowledgebase', 'db-schema', 'README.md')],
