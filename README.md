...
- **Reusable skills** — step-by-step instructions the AI follows for recurring tasks (workspace init, knowledge management, spec planning with UI mockups for frontend work, pull requests, code review, and `/workspace-cleanup` to find and remove files that don't belong in the workspace)
